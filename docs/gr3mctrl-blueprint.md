# gr3mctrl Blueprint – Next Milestone
...
- `/var/lib/gr3mctrl/config.json` (globale Settings)
- `/var/lib/gr3mctrl/stacks/<stack>/docker-compose.yml`
- `/var/lib/gr3mctrl/isos/<file>.iso`
- `/var/lib/gr3mctrl/templates/<vm>.json`
- `/var/lib/gr3mctrl/state.db` (BoltDB oder LiteFS für Metadaten)
...
- ISO-Library:
  - Upload (multi-part) → `/var/lib/gr3mctrl/isos`.
